...
public interface UserConverter {
    ...
    @Mapping(target = "profileVisible", expression = "java(java.util.Objects.equals(user.getProfileVisibility(), 1))")
    @Mapping(target = "emailPublic", expression = "java(java.util.Objects.equals(user.getEmailPublic(), 1))")
